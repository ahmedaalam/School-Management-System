      ...
      <div className="modal" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="modal-body">
          ...
          >
            ...
            (ID: {user?.studentId || user?._id.slice(-8)})? This action cannot
            be undone.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          >
            ...
            <div className="form-group">
              ...
              {classesLoading ? (
                <div className="form-input flex items-center gap-2 text-xs text-muted-foreground py-2">
...
function Dashboard() {
  ...
  const graduatedStudents = users.filter(
    (u) => u.status === "Graduated",
  ).length;
  const suspendedStudents = users.filter(
  ...
  const renderDashboardView = () => {
    ...
    const avgGPA =
      users.length > 0
        ? (gpas.reduce((a, b) => a + b, 0) / users.length).toFixed(2)
        : "0.00";
    const honorRoll = users.filter(
      (u) => parseFloat(calcGPA(u.grades || {})) >= 3.5,
    ).length;
    const atRisk = users.filter(
      (u) => parseFloat(calcGPA(u.grades || {})) < 2.0,
    ).length;

    // Demographics
    const genderDist = { Male: 0, Female: 0, Other: 0 };
    users.forEach((u) => {
      if (u.gender in genderDist) genderDist[u.gender]++;
    });
    ...
    const infraTotal =
      setupCounts.campuses +
      setupCounts.subjects +
      setupCounts.classes +
      setupCounts.sections +
      ...
      <div className="tab-view-content">
        <div className="page-header">
          ...
          <p className="page-subtitle">
            Welcome back, {admin?.name || "Admin"}. Overall performance and
        ...
        <div className="analytics-grid">
          ...
          <div className="card">
            ...
            <div className="card-body">
              <div className="analytics-big-metric">
                <span
                  className="analytics-big-value"
                  style={{ color: getGPAColor(parseFloat(avgGPA)) }}
                >
                  {avgGPA}
                </span>
          ...
          <div className="card">
            ...
            <div className="card-body">
              <div className="analytics-big-metric">
                ...
                <span className="analytics-big-label">
                  ...
                  <div key={item.label} className="analytics-bar-row">
                    ...
                    <div className="analytics-bar-track">
                      <div
                        ...
                        style={{
                          width: `${attTotal > 0 ? (item.count / attTotal) * 100 : 0}%`,
          ...
          <div className="card">
            ...
            <div className="card-body">
              {statusDist.map((s) => {
                const pct =
                  totalStudents > 0 ? (s.count / totalStudents) * 100 : 0;
                return (
                  <div
                    key={s.label}
        ...
        <div
          ...
          style={{ gridTemplateColumns: "1fr", gap: "20px", marginTop: 20 }}
        >
                ...
                >
                  {recentStudents.map((st) => (
                    ...
                    >
                      ...
                      <span
                        className={`status-pill ${(st.status || "Active").toLowerCase()}`}
      ...
      <div className="tab-view-content">
        ...
        >
          <div>
            ...
            <p className="page-subtitle">
              View list of all enrolled students, search, edit details, or
              remove profiles.
            </p>
          </div>
        </div>
          ...
          <div className="p-0">
            {loading ? (
              <div className="p-8 flex items-center justify-center text-muted-foreground">
                <Loader2 className="animate-spin mr-2" /> Loading student
                records…
              </div>
            ) : sorted.length === 0 ? (
              ...
              <Table>
                ...
                <TableBody>
                  {sorted.map((user) => (
                    <TableRow
                      key={user._id}
                      onClick={() => setActiveDrawerStudent(user)}
  ...
  const renderAcademicsView = () => {
    ...
    const avgGPA = classGPAs.length
      ? (classGPAs.reduce((a, b) => a + b, 0) / classGPAs.length).toFixed(2)
      : "0.00";
    const topStudents = [...users]
      .sort(
        (a, b) =>
          parseFloat(calcGPA(b.grades || {})) -
          parseFloat(calcGPA(a.grades || {})),
      )
      .slice(0, 3);
    ...
    const handleSaveGrades = async () => {
      ...
      try {
        await api.put(`${API}/${student._id}`, {
          ...student,
          grades: academicsForm,
        });
    ...
    return (
      <div className="tab-view-content">
        ...
        >
          <div>
            <h1 className="page-title">Academics & Report Cards</h1>
            <p className="page-subtitle">
              Review and edit subject grades, calculate GPA, and view class
        ...
        <div
          className="stats-row"
          style={{ gridTemplateColumns: "repeat(3,1fr)", marginBottom: "24px" }}
        >
          <div className="stat-card">
            ...
            <div>
              ...
              <div className="stat-label">Class Avg GPA</div>
            </div>
          </div>
          <div className="stat-card">
            ...
            <div>
              <div className="stat-value">
                {
                  users.filter(
                    (u) => parseFloat(calcGPA(u.grades || {})) >= 3.7,
                  ).length
                }
              </div>
              <div className="stat-label">Honor Roll (≥3.7)</div>
            </div>
          </div>
          <div className="stat-card">
            ...
            <div>
              <div className="stat-value">
                {
                  users.filter((u) => parseFloat(calcGPA(u.grades || {})) < 2.0)
                    .length
                }
              </div>
              <div className="stat-label">At Risk (&lt;2.0 GPA)</div>
            </div>
          </div>
        </div>
            ...
            <div style={{ maxHeight: "460px", overflowY: "auto" }}>
              {users.length === 0 ? (
                <div className="empty-state">
                  <div className="empty-desc">No students found.</div>
                </div>
              ) : (
                users.map((u) => {
                  ...
                  return (
                    <div
                      ...
                      style={{
                        background:
                          academicsSelected === u._id
                            ? "rgba(99,102,241,0.06)"
                            : "transparent",
                      }}
                      onClick={() => {
                        setAcademicsSelected(u._id);
                        setAcademicsEditing(false);
                        setAcademicsForm(u.grades || {});
                      }}
                    >
                      <div
                        className="avatar"
            ...
            >
              <div className="empty-state">
                ...
                <div className="empty-desc">
                  Click a student on the left to view their report card.
                </div>
              </div>
            </div>
          ) : (
              ...
              >
                ...
                {!academicsEditing ? (
                  <button
                    className="btn btn-ghost btn-sm"
                    onClick={() => {
                      setAcademicsEditing(true);
                      setAcademicsForm({ ...student.grades });
                    }}
                  >
                  ...
                  <div style={{ display: "flex", gap: "8px" }}>
                    <button
                      className="btn btn-ghost btn-sm"
                      onClick={() => setAcademicsEditing(false)}
                      disabled={academicsSaving}
                    >
                      Cancel
                    </button>
                    <button
              ...
              <div className="card-body">
                ...
                >
                  ...
                  <div style={{ flex: 1 }}>
                    ...
                    >
                      <span
                        className={`status-pill ${(student.status || "Active").toLowerCase()}`}
                ...
                >
                  {SUBJECTS.map((sub) => {
                    const gradeKey = academicsEditing
                      ? academicsForm[sub] || "A"
                      : student.grades?.[sub] || "A";
    ...
    try {
      ...
      users.forEach((u) => {
        const record = fetchedRecords.find(
          (r) => r.student?._id === u._id || r.student === u._id,
        );
  ...
  useEffect(() => {
    if (attendanceSelected) {
      api
        .get(`/attendance/student/${attendanceSelected}`)
  ...
  const renderAttendanceView = () => {
    const presentCount = Object.values(rollCall).filter(
      (s) => s === "Present",
    ).length;
    const absentCount = Object.values(rollCall).filter(
      (s) => s === "Absent",
    ).length;
    const lateCount = Object.values(rollCall).filter(
      (s) => s === "Late",
    ).length;
    const attendanceRate =
      users.length > 0 ? Math.round((presentCount / users.length) * 100) : 0;

    const selectedStudent = attendanceSelected
      ? users.find((u) => u._id === attendanceSelected)
      : null;
      ...
      <div className="tab-view-content">
        ...
        >
          <div>
            ...
            <p className="page-subtitle">
              Mark daily attendance, view per-student logs, and monitor class
              attendance rates.
            </p>
          </div>
          <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
            <div className="input-with-icon" style={{ width: "auto" }}>
              ...
              <input
                type="date"
                className="form-input"
                style={{ paddingLeft: "38px", width: "170px" }}
            ...
            <button
              ...
              disabled={attendanceSaving || users.length === 0}
            >
              {attendanceSaving ? (
                <>
                  <Loader2 size={14} className="spin-icon" /> Saving…
                      ...
                      <tr
                        ...
                        onClick={() =>
                          setAttendanceSelected(
                            u._id === attendanceSelected ? null : u._id,
                          )
                        }
                        style={{
                          cursor: "pointer",
                          background:
                            attendanceSelected === u._id
                        ...
                        <td>
                          <div className="user-cell">
                            ...
                            <div>
                              ...
                              <div className="user-id">{u.email}</div>
                            </div>
                          </div>
                        </td>
                        <td>
          ...
          <div className="card">
            ...
            {!selectedStudent ? (
              <div className="empty-state" style={{ padding: "40px 20px" }}>
                ...
                <div className="empty-title">Select a student</div>
                <div className="empty-desc">
                  Click any row on the left to view their attendance history.
                </div>
              </div>
            ) : (
              <div style={{ maxHeight: "460px", overflowY: "auto" }}>
                {studentLog.length === 0 ? (
                  <div className="empty-state" style={{ padding: "32px 20px" }}>
                    <div className="empty-desc">No attendance records yet.</div>
                  </div>
                ) : (
                  studentLog.map((entry, i) => (
                    <div key={i} className="att-log-row">
                      ...
                      <span
                        className={`att-status-badge att-badge-${entry.status.toLowerCase()}`}
                      >
            ...
            {selectedStudent && (
              ...
              >
                {studentLog.filter((e) => e.status === "Present").length}{" "}
                Present ·{" "}
                {studentLog.filter((e) => e.status === "Absent").length} Absent
                · {studentLog.filter((e) => e.status === "Late").length} Late
              </div>
            )}
          </div>
        </div>
    ...
    return (
      <div className="tab-view-content animate-fade-in">
        <div className="page-header">
          ...
          <p className="page-subtitle">
            Configure regional parameters, institution details, and
            ...
            >
              <div className="form-group">
                ...
                <select
                  ...
                  onChange={(e) =>
                    setSettings((s) => ({ ...s, tokenExpiry: e.target.value }))
                  }
                >
  ...
  return (
    <>
      ...
      >
        ...
        {tab === "campuses" && (
          <CampusesPanel api={api} showToast={showToast} />
        )}
        {tab === "subjects" && (
          <SubjectsPanel api={api} showToast={showToast} />
        )}
        {tab === "classes" && (
          <SetupClassStep api={api} showToast={showToast} />
        )}
        {tab === "sections" && (
          <SectionsPanel api={api} showToast={showToast} />
        )}
        {tab === "timetable" && (
          <TimetablePanel api={api} showToast={showToast} />
        )}
          ...
          <div className="drawer-panel" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="drawer-body">
              <div className="drawer-avatar-section">
                <div className="drawer-big-avatar">
                  {getInitials(activeDrawerStudent.name)}
                </div>
                <h2>{activeDrawerStudent.name}</h2>
                <div className="drawer-id-badge">
                  {activeDrawerStudent.studentId || "Pending Code"}
                </div>
                <span
                  className={`status-pill ${(activeDrawerStudent.status || "Active").toLowerCase()}`}
                  style={{
                    marginTop: "12px",
                    fontSize: "13px",
                    padding: "6px 14px",
              ...
              <div className="drawer-details-grid">
                ...
                <div className="detail-item">
                  ...
                  <div className="detail-value">
                    {activeDrawerStudent.dob
                      ? new Date(activeDrawerStudent.dob).toLocaleDateString(
                          "en-US",
                          {
                            year: "numeric",
                            month: "long",
                ...
                <div className="detail-item">
                  ...
                  <div className="detail-value">
                    {activeDrawerStudent.gender}
                  </div>
                </div>

                <div className="detail-item">
                  <div className="detail-label">
                    <Award size={13} /> Grade / Class
                  </div>
                  <div className="detail-value">
                    {activeDrawerStudent.grade}
                  </div>
                </div>

                <div className="detail-item">
                  <div className="detail-label">
                    <Activity size={13} /> Enrollment Date
                  </div>
                  <div className="detail-value">
                    {activeDrawerStudent.createdAt
                      ? new Date(
                          activeDrawerStudent.createdAt,
              ...
              >
                <button
                  ...
                  onClick={() => {
                    setEditTarget(activeDrawerStudent);
                    setModal("edit");
                  }}
                >
